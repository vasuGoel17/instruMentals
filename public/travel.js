...
let songs = [
  {
    key: "1",
    songName: "Anjaana Anjaani Ki Kahani",
    coverPath: "songs/travel/1.mp3",
    filePath: "images/travel/1.jpg",
    duration: "4:46",
  },
  {
    key: "2",
    songName: "Aye khuda",
    coverPath: "songs/travel/2.mp3",
    filePath: "images/travel/2.jpg",
    duration: "4:43",
  },
  {
    key: "3",
    songName: "Gulabi Aankhen",
    coverPath: "songs/travel/3.mp3",
    filePath: "images/travel/3.jpg",
    duration: "3:44",
  },
  {
    key: "4",
    songName: "Hai Apna Dil To Awara",
    coverPath: "songs/travel/4.mp3",
    filePath: "images/travel/4.jpg",
    duration: "3:25",
  },
  {
    key: "5",
    songName: "Mann Mera",
    coverPath: "songs/travel/5.mp3",
    filePath: "images/travel/5.jpg",
    duration: "3:18",
  },
  {
    key: "6",
    songName: "Rang Jo Lagyo",
    coverPath: "songs/travel/6.mp3",
    filePath: "images/travel/6.jpg",
    duration: "4:56",
  },
  {
    key: "7",
    songName: "Pasoori",
    coverPath: "songs/travel/7.mp3",
    filePath: "images/travel/7.jpg",
    duration: "3:44",
  },
  {
    key: "8",
    songName: "Teri Meri Kahaani",
    coverPath: "songs/travel/8.mp3",
    filePath: "images/travel/8.jpg",
    duration: "4:06",
  },
  {
    key: "9",
    songName: "Yun Hi Chala Chal",
    coverPath: "songs/travel/9.mp3",
    filePath: "images/travel/9.jpg",
    duration: "7:27",
  },
  {
    key: "10",
    songName: "Zaalima",
    coverPath: "songs/travel/10.mp3",
    filePath: "images/travel/10.jpg",
    duration: "4:59",
  },
];
...
let audioElement = new Audio("songs/travel/1.mp3");
  ...
  element.addEventListener("click", (e) => {
    if (e.target.classList == "far songitemplay fa fa-play-circle") {
      ...
      if (pauseCheck != index) {
        ...
        audioElement.src = `songs/travel/${index}.mp3`;
        audioElement.play();
        masterPlay.classList.remove("fa-play-circle");
        masterPlay.classList.add("fa-pause-circle");
        gif.style.opacity = "1";
