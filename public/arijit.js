...
let songs = [
  {
    ...
    coverPath: "songs/arijit/1.mp3",
    filePath: "images/arijit/1.jpg",
    duration: "4:24",
  },
  {
    key: "2",
    songName: "Aabad Barbad",
    coverPath: "songs/arijit/2.mp3",
    filePath: "images/arijit/2.jpg",
    duration: "5:09",
  },
  {
    key: "3",
    songName: "Bekhayali",
    coverPath: "songs/arijit/3.mp3",
    filePath: "images/arijit/3.jpg",
    duration: "6:10",
  },
  {
    key: "4",
    songName: "Woh Din",
    coverPath: "songs/arijit/4.mp3",
    filePath: "images/arijit/4.jpg",
    duration: "4:18",
  },
  {
    key: "5",
    songName: "Khairiyat",
    coverPath: "songs/arijit/5.mp3",
    filePath: "images/arijit/5.jpg",
    duration: "4:31",
  },
  {
    key: "6",
    songName: "First Class",
    coverPath: "songs/arijit/6.mp3",
    filePath: "images/arijit/6.jpg",
    duration: "4:37",
  },
  {
    key: "7",
    songName: "Kalank",
    coverPath: "songs/arijit/7.mp3",
    filePath: "images/arijit/7.jpg",
    duration: "5:11",
  },
  {
    key: "8",
    songName: "Pachtaoge",
    coverPath: "songs/arijit/8.mp3",
    filePath: "images/arijit/8.jpg",
    duration: "3:46",
  },
  {
    key: "9",
    songName: "Shayad",
    coverPath: "songs/arijit/9.mp3",
    filePath: "images/arijit/9.jpg",
    duration: "4:08",
  },
  {
    key: "10",
    songName: "Tughe Kitna Chahne Lage Hum",
    coverPath: "songs/arijit/10.mp3",
    filePath: "images/arijit/10.jpg",
    duration: "4:44",
  },
];
...
let audioElement = new Audio("songs/arijit/1.mp3");
  ...
  element.addEventListener("click", (e) => {
    if (e.target.classList == "far songitemplay fa fa-play-circle") {
      ...
      if (pauseCheck != index) {
        ...
        audioElement.src = `songs/arijit/${index}.mp3`;
        audioElement.play();
        masterPlay.classList.remove("fa-play-circle");
        masterPlay.classList.add("fa-pause-circle");
        gif.style.opacity = "1";
