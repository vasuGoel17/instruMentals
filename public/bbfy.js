...
let songs = [
  {
    ...
    coverPath: "songs/bpfy/1.mp3",
    filePath: "images/bpfy/1.jpg",
    duration: "5:41",
  },
  {
    key: "2",
    songName: "Iktara",
    coverPath: "songs/bpfy/2.mp3",
    filePath: "images/bpfy/2.jpg",
    duration: "4:13",
  },
  {
    key: "3",
    songName: "Kabira",
    coverPath: "songs/bpfy/3.mp3",
    filePath: "images/bpfy/3.jpg",
    duration: "3:43",
  },
  {
    key: "4",
    songName: "Kaise Hua",
    coverPath: "songs/bpfy/4.mp3",
    filePath: "images/bpfy/4.jpg",
    duration: "3:54",
  },
  {
    key: "5",
    songName: "Kyon",
    coverPath: "songs/bpfy/5.mp3",
    filePath: "images/bpfy/5.jpg",
    duration: "4:25",
  },
  {
    key: "6",
    songName: "Mast Magan",
    coverPath: "songs/bpfy/6.mp3",
    filePath: "images/bpfy/6.jpg",
    duration: "4:40",
  },
  {
    key: "7",
    songName: "Nazm Nazm",
    coverPath: "songs/bpfy/7.mp3",
    filePath: "images/bpfy/7.jpg",
    duration: "3:55",
  },
  {
    key: "8",
    songName: "Phir Se Udd Chala",
    coverPath: "songs/bpfy/8.mp3",
    filePath: "images/bpfy/8.jpg",
    duration: "4:32",
  },
  {
    key: "9",
    songName: "Qafirana",
    coverPath: "songs/bpfy/9.mp3",
    filePath: "images/bpfy/9.jpg",
    duration: "5:41",
  },
  {
    key: "10",
    songName: "Saiyaan",
    coverPath: "songs/bpfy/10.mp3",
    filePath: "images/bpfy/10.jpg",
    duration: "5:09",
  },
];
...
let audioElement = new Audio("songs/bpfy/1.mp3");
  ...
  element.addEventListener("click", (e) => {
    if (e.target.classList == "far songitemplay fa fa-play-circle") {
      ...
      if (pauseCheck != index) {
        ...
        audioElement.src = `songs/bpfy/${index}.mp3`;
        audioElement.play();
        masterPlay.classList.remove("fa-play-circle");
        masterPlay.classList.add("fa-pause-circle");
        gif.style.opacity = "1";
