...
let songs = [
  {
    ...
    coverPath: "songs/ap/1.mp3",
    filePath: "images/ap/1.jpg",
    duration: "3:49",
  },
  {
    key: "2",
    songName: "Brown Munde",
    coverPath: "songs/ap/2.mp3",
    filePath: "images/ap/2.jpg",
    duration: "4:53",
  },
  {
    key: "3",
    songName: "Desires",
    coverPath: "songs/ap/3.mp3",
    filePath: "images/ap/3.jpg",
    duration: "2:56",
  },
  {
    key: "4",
    songName: "Dil Nu",
    coverPath: "songs/ap/4.mp3",
    filePath: "images/ap/4.jpg",
    duration: "3:12",
  },
  {
    key: "5",
    songName: "Excuses",
    coverPath: "songs/ap/5.mp3",
    filePath: "images/ap/5.jpg",
    duration: "2:31",
  },
  {
    key: "6",
    songName: "Final Thoughts",
    coverPath: "songs/ap/6.mp3",
    filePath: "images/ap/6.jpg",
    duration: "3:37",
  },
  {
    key: "7",
    songName: "Hills",
    coverPath: "songs/ap/7.mp3",
    filePath: "images/ap/7.jpg",
    duration: "2:39",
  },
  {
    key: "8",
    songName: "Summer High",
    coverPath: "songs/ap/8.mp3",
    filePath: "images/ap/8.jpg",
    duration: "2:57",
  },
  {
    key: "9",
    songName: "Tere Te",
    coverPath: "songs/ap/9.mp3",
    filePath: "images/ap/9.jpg",
    duration: "1:54",
  },
  {
    key: "10",
    songName: "Wo Noor",
    coverPath: "songs/ap/10.mp3",
    filePath: "images/ap/10.jpg",
    duration: "3:19",
  },
];
  ...
  element.addEventListener("click", (e) => {
    if (e.target.classList == "far songitemplay fa fa-play-circle") {
      ...
      if (pauseCheck != index) {
        ...
        audioElement.src = `songs/ap/${index}.mp3`;
        audioElement.play();
        masterPlay.classList.remove("fa-play-circle");
        masterPlay.classList.add("fa-pause-circle");
        gif.style.opacity = "1";
