...
let songs = [
  {
    ...
    coverPath: "songs/brahmastra/1.mp3",
    filePath: "images/brahmastra/1.jpg",
    duration: "4:05",
  },
  {
    key: "2",
    songName: "Deva Deva",
    coverPath: "songs/brahmastra/2.mp3",
    filePath: "images/brahmastra/2.jpg",
    duration: "4:39",
  },
  {
    key: "3",
    songName: "Kesariya",
    coverPath: "songs/brahmastra/3.mp3",
    filePath: "images/brahmastra/3.jpg",
    duration: "4:28",
  },
  {
    key: "4",
    songName: "Rasiya",
    coverPath: "songs/brahmastra/4.mp3",
    filePath: "images/brahmastra/4.jpg",
    duration: "4:25",
  },
  {
    key: "5",
    songName: "Shiva Theme",
    coverPath: "songs/brahmastra/5.mp3",
    filePath: "images/brahmastra/5.jpg",
    duration: "3:11",
  },
];
...
let audioElement = new Audio("songs/brahmastra/1.mp3");
  ...
  element.addEventListener("click", (e) => {
    if (e.target.classList == "far songitemplay fa fa-play-circle") {
      ...
      if (pauseCheck != index) {
        ...
        audioElement.src = `songs/brahmastra/${index}.mp3`;
        audioElement.play();
        masterPlay.classList.remove("fa-play-circle");
        masterPlay.classList.add("fa-pause-circle");
        gif.style.opacity = "1";
