...
let songs = [
  {
    ...
    coverPath: "songs/honey/1.mp3",
    filePath: "images/honey/1.jpg",
    duration: "3:30",
  },
  {
    key: "2",
    songName: "Blue Eyes",
    coverPath: "songs/honey/2.mp3",
    filePath: "images/honey/2.jpg",
    duration: "3:41",
  },
  {
    key: "3",
    songName: "Brown Rang",
    coverPath: "songs/honey/3.mp3",
    filePath: "images/honey/3.jpg",
    duration: "2:59",
  },
  {
    key: "4",
    songName: "Char Bottle Vodka",
    coverPath: "songs/honey/4.mp3",
    filePath: "images/honey/4.jpg",
    duration: "3:45",
  },
  {
    key: "5",
    songName: "Dheere Dheere",
    coverPath: "songs/honey/5.mp3",
    filePath: "images/honey/5.jpg",
    duration: "3:32",
  },
  {
    key: "6",
    songName: "Dope Shope",
    coverPath: "songs/honey/6.mp3",
    filePath: "images/honey/6.jpg",
    duration: "3:08",
  },
  {
    key: "7",
    songName: "High Heels",
    coverPath: "songs/honey/7.mp3",
    filePath: "images/honey/7.jpg",
    duration: "4:57",
  },
  {
    key: "8",
    songName: "BreakUp Party",
    coverPath: "songs/honey/8.mp3",
    filePath: "images/honey/8.jpg",
    duration: "4:42",
  },
  {
    key: "9",
    songName: "Love Dose",
    coverPath: "songs/honey/9.mp3",
    filePath: "images/honey/9.jpg",
    duration: "3:48",
  },
  {
    key: "10",
    songName: "One Bottle Down",
    coverPath: "songs/honey/10.mp3",
    filePath: "images/honey/10.jpg",
    duration: "3:16",
  },
];
...
let audioElement = new Audio("songs/honey/1.mp3");
  ...
  element.addEventListener("click", (e) => {
    if (e.target.classList == "far songitemplay fa fa-play-circle") {
      ...
      if (pauseCheck != index) {
        ...
        audioElement.src = `songs/honey/${index}.mp3`;
        audioElement.play();
        masterPlay.classList.remove("fa-play-circle");
        masterPlay.classList.add("fa-pause-circle");
        gif.style.opacity = "1";
